...
const BFModal = (props) => {
    ...
    const modalBuild = () => {
        return (
            <div className={`bf-modal ${modalFadeIn ? 'active' : ''} ${className}`}>
                <div className={'bf-modal__box'}>
                    <div className={'bf-modal__cont'}>
                        {
                            defaultClose &&
                            <div>
                                <button
                                    className={'bf-modal__close-button'}
                                    type={'button'}
                ...
                </div>
                {
                    closeOuter &&
                    <div
                        className={'bf-modal__button-close-outer'}
                        onClick={handleModalClose}
                    ></div>
                }
            </div>
